              ...
              <div className="col-md-6 col-md-offset-3">
                ...
                {!this.state.loading && <div className="tab-content">
                          ...
                          {this.state.tasks.length > 0 && !this.state.loading && this.state.page == "tasks" && <ul className="nav nav-tabs" role="tablist">
                            <li role="presentation" className="active" onClick={() => {
                              ...
                              <a href="#all" aria-controls="home" role="tab" data-toggle="tab">
                                <i className="fa fa-envelope-o"></i>All Tasks</a>
                            </li>
                            <li onClick={() => {
                              this.setState({"selectedtask": null, result: false})
                              this.loadTasks()
                            }} role="presentation">
                              <a href="#mine" aria-controls="profile" role="tab" data-toggle="tab">
                                <i className="fa fa-cube"></i>My tasks</a>
                            </li>
                          </ul>}
                          {this.state.page == "tasks" && <div id="home" className="tab-pane fade in active">
                            <div className="tab-content">
                              <div id="all" className="tab-pane fade in active" role="tabpanel">
                                <div className="">
                                  <br/> {this.state.pagedTasks.length != 0 && !this.state.selectedtask && !this.state.loading && <div className="" style={{
                                    "padding": "1%"
                                  }}>
                                    <div className="" style={{
                                      "overflowX": "auto"
                                      ...
                                      <table className="table table-hover ">
                                        <thead>
                                          <tr>
                                            <th>Title</th>
                                            {this.state.project.Project_config.includes("assigned_to") && <th>
                                              Assigned To</th>}
                                        ...
                                        <tbody>
                                          {this.state.pagedTasks.map((item, i) => {
                                            return <tr key={i} onClick={() => {
                                              ...
                                              <td>{item.title}</td>
                                              {this.state.project.Project_config.includes("assi{item.priority ? item.priority : '-'}gned_to") && <td>{item.assigned_to.username
                                                  ? item.assigned_to.username
                                                  : "-"}</td>}
                                              {this.state.project.Project_config.includes("priority") && <td></td>}
                                      ...
                                      {this.state.pageCount > 1 && <div className="commentBox">
                                        <ReactPaginate previousLabel={"previous"} nextLabel={"next"} breakLabel={< a href = "" > ...</a>} breakClassName={"break-me"} pageCount={this.state.pageCount} marginPagesDisplayed={2} pageRangeDisplayed={5} onPageChange={this.handlePageClick} containerClassName={"pagination"} subContainerClassName={"pages pagination"} activeClassName={"active"}/>
                                      </div>}
                                    </div>
                                  </div>
}
                  ...
                  {this.state.page == "details" && <div id="menu2">
                    {this.state.workers && this.state.project && currentComponent === "details" && <ProjectDetails id={id} project={this.state.project} mapid={this.state.project.mapid} workers={this.state.workers}/>
}
                  </div>}
                  {this.state.page == "about" && <div id="about">
